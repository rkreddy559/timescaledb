...
**High-level changes**
* New histogram function added for getting the frequency of a column's values. For detailed usage, see [our docs](http://docs.timescale.com/api#advanced-analytics).
...
* Improved support for constraints on hypertables.
